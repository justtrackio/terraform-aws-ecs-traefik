...
| <a name="input_additional_vpc_id"></a> [additional\_vpc\_id](#input\_additional\_vpc\_id) | Additional vpc ids that should get associated with the route53 hostzone | `list(string)` | `[]` | no |
